...
public class wenxuan_ProfilePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wenxuan_profile);
...
//                Intent loadUAvail = new Intent(wenxuan_ProfilePage.this, MyAvailability.class);
...
//                Intent openMenu = new Intent(wenxuan_ProfilePage.this, MainMenu.class);
...
//        });
        resourcesPageBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent openMenu = new Intent(wenxuan_ProfilePage.this, ResourcesPage.class);
                startActivity(openMenu);
            }
        });
